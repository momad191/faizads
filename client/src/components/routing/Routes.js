...
import Edit from '../profile-forms/Edit';
...
const Routes = () => {
    ...
    <section className='container'>
     ...
     {/* <Alert /> */}
      ...
      <Route exact path='/payment/cancel' component={cancel} />
        ...
        <Route exact path='/WebinarsRegistration' component={WebinarsRegistration} />
        ...
        <PrivateRoute exact path='/dashboard/shops/edit' component={Edit} />
        <PrivateRoute exact path='/:lang/dashboard/shops/edit' component={Edit} />
        ...
        <Route exact path='/:country/:city/:market/:purpose/posts/:id' component={Post} />
  ...
  {/* affiliate section */}
        ...
        <Route exact path='/main/:id/:city/:market_code/:purpose' component={mainPurpose} />
        
        <Route exact path='/main/:id/:city/:market_code/:purpose/:category_code' component={mainCategory} />
       
        <Route exact path='/main/:country/:city/:market_code/:purpose/:category_code/posts/:id' component={Post} />
