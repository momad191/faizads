...
const about = () => {
  return (
    <Fragment>
      ...
      <div className="about-title"> حول موقع MOMAD  </div>  
      ...
      يتميز فريقنا بعدم الوقوف في نقطة واحدة مطلقا مهما واجهتهم التحديات، ‏ويذهبون بطموحهم الى مسافات بعيدة، تعرف على المزيد حول الثقافة والقيم ‏التي تدفعهم للأمام.‏
       ...
       <p className='about-paragraph'>
       تأسس موقعنا والذي تديره وتملكه شركة ‏MOMAD  ‎‏ المحدودة عام ‏‏2021م،
وبخبرتنا الطويلة في مجال تكنلوجيا المعلومات والتسويق الإلكتروني، كنا ‏الفريق المسؤول عن هذه المنصة، ودائما ما نبحث عن مشاريع جديدة  ‏لتنفيذها على شبكة الانترنت حيث النمو السريع والفرص الغير محدودة.‏
        </p>

<h1 className='about-title'> رؤيتنا</h1>
        <p className='about-paragraph'>
        أن نكون في طليعة القيمة الاقتصادية المضافة والمرتبطة بنشاط تجاري ‏واستثماري طويل الأجل ومستدام  لأجل العالم.‏
</p>


<h1 className='about-title'> قيمنا </h1>
   <ul className='about-paragraph'>
<li>أن نكون الخيار المفضل لشركائنا وعملائنا الاستراتيجيين.‏ </li>
