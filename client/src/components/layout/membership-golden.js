...
const Golden = ({ setAlert ,addSubscription, isAuthenticated, match }) => {
  ...
  const membershiptype = "626a5489f9896eba9e26ead6";
  const membership_class = 'golden';
  const Payment_status ='ok';
  const available_ads = 240;
     ...
     <div className="aqle3-main" >
      ...
      <center>
        <div className="side-columns">
         ...
         <li className="grey">$ 31.00 / لمدة شهر </li>
      ...
      <div class="login-title">  الإشترك في الخطة الذهبية  </div>
...
<center>
  <div className="side-columns">
   ...
   <li className="grey">$ 31.00 / For a Month</li>
   <li className="boldy">{user.first_name}  {user.last_name} </li>
   <li className="boldy"> {user.email} </li>
   <li className="boldy"> {user.country_name}</li>
...
<div class="login-title">  Subscribe to the golden plan  </div>
