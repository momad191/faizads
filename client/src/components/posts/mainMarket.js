...
handleSelectClassifieds = event => {
  ...
  componentDidMount() {
    axios.get('/api/posts/homePage/'+ this.props.match.params.id +'/'+ this.props.match.params.city +'/'+ this.props.match.params.market_code)
      .then(response => {
...
allMarketsList(){
  ...
  .map(market => {
      return <Link 
      to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${market.m_code}/${market.m_code}`} 
      className="categoryListButton">
      {market.m_AR_name} 
       </Link>
   })
...
<Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/vacancies`} > <button className='Purposebtn'>   وظائف شاغرة  </button></Link>
<Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/seeking-work`} > <button className='Purposebtn'>   يبحث عن وظيفة  </button></Link>
...
<div style={{width:'100%'}}>   
    <Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/ask-rent`} > <button className='Purposebtn'>   مطلوب للإيجار  </button></Link>
    <Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/ask-buy`} > <button className='Purposebtn'>   مطلوب للشراء  </button></Link>

    <Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/rental`} > <button className='Purposebtn'>   للإيجار  </button></Link>
    <Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/for-sale`} > <button className='Purposebtn'>   للبيع  </button></Link>
    </div>
