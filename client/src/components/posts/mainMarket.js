...
{/* //////////////////////////////////////////////////////انتهاء القائمة الجانبية ///////////////////////////////////////////// */}
 ...
 {this.props.match.params.market_code === 'jobs' ?(
  ...
  <Fragment>
   <div style={{width:'100%'}}> 
<Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/vacancies`} > <button className='Purposebtn'>   
<Translation>{t => <>{t('vacanciesButton')}</>}</Translation>
  </button></Link>
<Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/seeking-work`} > <button className='Purposebtn'>   
<Translation>{t => <>{t('seeking-workButton')}</>}</Translation>
  ...
  <div style={{width:'100%'}}> 
    ...
    <Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/ask-rent`} > <button className='Purposebtn'>   
    <Translation>{t => <>{t('ask-rentButton')}</>}</Translation>
      </button></Link>
    <Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/ask-buy`} > <button className='Purposebtn'>   
    <Translation>{t => <>{t('ask-buyButton')}</>}</Translation>
      </button></Link>

    <Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/rental`} > <button className='Purposebtn'>  
    <Translation>{t => <>{t('rentalButton')}</>}</Translation>
      </button></Link>
    <Link to={`/main/${this.props.match.params.id}/${this.props.match.params.city}/${this.props.match.params.market_code}/for-sale`} > <button className='Purposebtn'>   
