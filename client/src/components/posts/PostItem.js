...
//   const One =  oneSrtarPercent.toPrecision(2);
  ...
  <Fragment>
      ...
      <div className={selectpic0}><img className="detail-no-picture" alt={title} src={noimg} /> </div> 
...
{isAuthenticated ?(
        ...
        <div className="post-contact-show" >    
         <MessageForm toUser={user.username}   />
          ...
          <Fragment>
      <div className="post-contact-show" >    </div>
          </Fragment>
       ...
       <a className="post-contact-show" href={`${shop.shop_website}`} target="_blank"> 
...
<div className="pic-slider-container2"> 
