...
handleSelectClassifieds = event => {
  ...
  componentDidMount() {
    axios.get('/api/posts/homePage/'+ this.props.match.params.id +'/'+ this.props.match.params.city +'/'+ this.props.match.params.market_code +'/'+ this.props.match.params.purpose)
      .then(response => {
